...
import { sendGroupMessage } from '../../realtimeCommunication/socketConnection';
...
const NewGroupMessageInput = ({chosenChatDetails}) => {
...
export default connect(mapStoreStateToProps)(NewGroupMessageInput);